...
export class BlogComponent {
  ...
  categories: BlogCategory[] = [
    { id: 'all', name: 'Todos los Artículos', count: 0 },
    { id: 'development', name: 'Desarrollo Web', count: 0 },
    { id: 'design', name: 'Diseño UX/UI', count: 0 },
    { id: 'technology', name: 'Tecnología', count: 0 },
    { id: 'tips', name: 'Tips & Consejos', count: 0 },
    { id: 'tutorials', name: 'Tutoriales', count: 0 },
    { id: 'business', name: 'Negocios Digitales', count: 0 }
  ];
